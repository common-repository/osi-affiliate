...
$osi_hss_snippetStatus = intval( esc_sql( $_GET['status'] ) );
...
if ($snippetCount == 0) {
    ...
    $wpdb->update($wpdb->prefix . 'osi_hss_short_code', array('status' => $osi_hss_snippetStatus), array('id' => $osi_hss_snippetId));
    osi_js_redirect('page=html-snippet-shortcode-manage&osi_hss_msg=4&pagenum=' . $osi_hss_pageno);
}